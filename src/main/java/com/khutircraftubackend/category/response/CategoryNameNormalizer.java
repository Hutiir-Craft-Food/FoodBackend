...
public class CategoryNameNormalizer {
    ...
    public static final String APOSTROPHE_CLASS = "[\\u0027\\u02B9\\u02BB\\u02BC\\u02BE\\u02C8\\u02EE\\u0301\\u0313\\u0315\\u055A\\u05F3\\u07F4\\u07F5\\u1FBF\\u2018\\u2019\\u2032\\uA78C\\uFF07]";
    private static final String UNICODE_SPACES_CLASS = "[\\s\\u00A0\\u2007\\u202F]";
    public static final String CATEGORY_NAME_PATTERN = "^[а-щА-ЩЬьЮюЯяЇїІіЄєҐґ\\d\\s.,:;_+\\-()%&" + APOSTROPHE_CLASS + "]+$";
    ...
    public static String normalizeForDisplayName(String input) {
        ...
        return nfc
                .strip()
                .replaceAll(APOSTROPHE_CLASS, "ʼ")// Уніфікація апострофів
