...
public class ProductService {
    ...
    @Transactional(readOnly = true)
    public Map<String, Object> getFeaturedProducts(int offset, int limit) {
        
        Pageable pageable = PageRequest.of(0, Math.min(limit, 16),
        ...
        return Map.of(
                "products", products,
                "total", productEntities.getTotalElements(),
                "offset", offset,
                "limit", limit
        );
    }
