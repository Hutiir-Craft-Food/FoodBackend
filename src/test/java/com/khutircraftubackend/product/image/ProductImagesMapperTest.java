...
//                .build();
//
//        ProductImagesResponse.Image dto = mapper.toDto(entity);
//
//        assertEquals("uid123", dto.uid());
//        // assertEquals("link.jpg", dto.link());
//        assertEquals(ImageSize.LARGE, dto.tsSize());
...
//                ProductImageEntity.builder().uid("uid1").link("link1").tsSize(ImageSize.LARGE).position(0).build(),
//                ProductImageEntity.builder().uid("uid2").link("link2").tsSize(ImageSize.SMALL).position(1).build()
//        );
//
...
//        assertEquals(ImageSize.LARGE, response.images().get(0).tsSize());
