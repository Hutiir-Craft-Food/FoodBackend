...
public class ProductServiceTest {
    ...
    void testCreateProduct_Success() throws IOException {
        ...
        when(cloudinaryService.uploadResource(mockThumbnailFile)).thenReturn("uploaded-thumbnail-url");
        when(cloudinaryService.uploadResource(mockImageFile)).thenReturn("uploaded-image-url");
    ...
    void testDeleteProduct_Success() throws IOException {
        ...
        doNothing().when(cloudinaryService).deleteResourceById("Test image");
        doNothing().when(cloudinaryService).deleteResourceById("Test thumbnail");

        productService.deleteProduct(1L);

        verify(productRepository, times(1)).delete(product);
        verify(cloudinaryService, times(1)).deleteResourceById("Test image");
        verify(cloudinaryService, times(1)).deleteResourceById("Test thumbnail");
    }
